...
\bigskip
\bigskip
The one that maximizes the hyperplanes' distance from the nearest datapoints of either class while classifying all data correctly - \textbf{the margin}
\end{center}}
\column{0.55\textwidth}
\begin{center}
\only<+->{
...
\end{align*}}
\only<+->{
under the constraint that \textbf{all data are classified correctly}.}
\end{center}
\column{0.55\textwidth}
\begin{center}
\begin{figure}
