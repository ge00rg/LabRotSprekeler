...
\title{Multivariate Analysis of Dendritic Ca2+ Data}
...
\section{What Has Happened So Far - Univariate Analysis}

\begin{frame}{Psychometric Curve}
\begin{center}
	\begin{figure}
...
\begin{frame}{$\text{Ca}^{2+}$-Trace of Largest $|\text{DI}|$-Dendrites}
\begin{center}
	\begin{figure}
